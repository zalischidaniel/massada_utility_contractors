...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            alert(`Thank you, ${senderName}! Your project inquiry has been recorded. For immediate scheduling or bid inquiries, you can also call Massada directly at (417) 647-5021 or email admin@massada.company.`);
            contactForm.reset();
        });
    }
});
